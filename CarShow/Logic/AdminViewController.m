...
#if CarShowType == 20
    // 区域车展
    [self exportAutoShowDataCSV:output];
    
#elif CarShowType == 21
    // 上海车展
    [self exportSHDataCSV:output];
    
#elif CarShowType == 22
    // A级车展
    [self exportADataCSV:output];
    
#endif
    
}

- (void)exportAutoShowDataCSV:(NSOutputStream *)output
{
...
- (void)exportADataCSV:(NSOutputStream *)output
{
    NSString *header = @"ID,项目活动编码,姓名,性别,手机,EMAIL,经销商省份,经销商城市,经销商名称,提交时间,活动名称,活动城市,录入,最感兴趣车型,还感兴趣车型,何时(再)购车,购车预算,是否需要购车服务,isreceiving\n";
...
- (void)exportSHDataCSV:(NSOutputStream *)output
{
    NSString *header = @"ID,项目活动编码,姓名,性别,手机,EMAIL,经销商省份,经销商城市,经销商名称,提交时间,活动名称,活动城市,录入,最感兴趣车型,还感兴趣车型,何时(再)购车,购车预算,车展中最喜欢车型,是否需要购车服务,是否贷款购买福特,是否接收促销信息,isreceiving\n";
    ...
    for (int i = 0; i<dataArrayCount-1; i++) {
        ...
        // ID,项目活动编码,姓名,性别,手机,EMAIL,经销商省份,经销商城市,经销商名称,提交时间,活动名称,活动城市,录入,最感兴趣车型,还感兴趣车型,何时(再)购车,购车预算,车展中最喜欢车型,是否需要购车服务,是否贷款购买福特,是否接收促销信息,isreceiving
        NSString *row = [NSString stringWithFormat:@"%@,%@,%@,%@,%@,%@, %@,%@,%@,%@,%@, %@,%@,%@,%@,%@,  %@,%@,%@,%@,%@, %@\n",
                         [params objectForKey:@"q_id"],
                         PROJECT_CODE,
                         [params objectForKey:@"qname"],
